  ...
  render() {
    return (
      <div >
        ...
        <span class="site-heading-lower">Nossa Senhora de FÃ¡tima</span-->*/}
      ...
      <div class="container">
        <div class="intro">
          ...
          <div class="intro-text left-0 text-center bg-faded p-5 rounded">
            ...
            <p class="mb-3">Todos os trabalhos desenvolvidos pela Morada da Melhor Idade só é possivel pela ajuda incansável de nossos voluntários.
            </p>
